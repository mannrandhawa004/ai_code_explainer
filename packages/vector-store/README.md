...
This package owns connectivity, health reporting, collection compatibility checks, payload indexes, validated batched upserts, semantic retrieval, and tenant-scoped repository deletion.
