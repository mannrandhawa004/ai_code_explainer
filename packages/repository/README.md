...
Step 6 introduces public GitHub repository cloning. Step 7 adds bounded, deterministic file discovery without following symbolic links. Later steps add filtering, parsing, and chunking to this package.
